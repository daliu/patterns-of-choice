...
- **R6. Moral conviction / metaethical objectivism** — *do you hold a given moral position as an objective fact (true for everyone, mind-independent) or as a preference/opinion?* The **meta-stance toward one's own values**, distinct from their content (the inventory), their tradeability (R2 sacred values), and their centrality to the self (R1). Strong, well-replicated behavioral payload: conviction predicts intolerance of dissent, refusal to compromise/negotiate, and willingness to accept any-means-to-the-end. The clearest gap on the map. Anchors: Skitka 2010 (moral conviction); Goodwin & Darley 2008 (metaethical objectivism). **Priority: HIGH** — clean, distinct, important; next iteration.
