...
- **R3. Moral disengagement** — the mechanisms that switch off moral self-sanction (Bandura 1999/2002: euphemistic labeling, diffusion of responsibility, advantageous comparison, dehumanization). *How* you let yourself off the hook; overlaps the moral-language channel (A3) for detection. ← *next*
