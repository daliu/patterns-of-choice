...
- **R1. Moral identity centrality** — how central *being moral* is to the self-concept (Aquino & Reed 2002 Moral Identity Scale, **already in the repo's references**). Not *what* you value but how load-bearing morality is to who-you-are — a moderator of every other branch. Reuses the inventory's identity-vs-trait split. ← *next*
