...
- [x] Scenario corpus, schema-validated (currently 43/48; sufficient for n=10 pilot)
...
- [ ] **Author final 5 scenarios** to reach 48 corpus total (currently 43). Symmetric 12/domain (or another sensible allocation). Output: 48 scenarios all passing validator.
