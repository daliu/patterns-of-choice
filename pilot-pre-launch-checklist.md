...
- [x] Scenario corpus, schema-validated (currently 47/48; sufficient for n=10 pilot)
...
- [ ] **Author final 1 scenario** to reach 48 corpus total (currently 47). Distribution: 6 QF + 3 Narr + 3 CoV per domain × 4 — only cov-reciprocity-003 left for full 3-CoV-per-domain symmetry. Output: 48 scenarios all passing validator.
