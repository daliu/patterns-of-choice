...
- [x] Scenario corpus, schema-validated (currently 46/48; sufficient for n=10 pilot)
...
- [ ] **Author final 2 scenarios** to reach 48 corpus total (currently 46). Distribution so far: 6 QF + 3 Narr + 2 CoV per domain × 4 = 44, plus cov-truth-003 + cov-allocation-003. Remaining 2 likely cov-ingroup-003 and cov-reciprocity-003 for full 3-CoV-per-domain symmetry. Output: 48 scenarios all passing validator.
