...
- [x] Scenario corpus, schema-validated (currently 44/48; sufficient for n=10 pilot)
...
- [ ] **Author final 4 scenarios** to reach 48 corpus total (currently 44; symmetric 6 QF / 3 Narr / 2 CoV per domain × 4 = 44, with 4 more scattered across domain choices). Output: 48 scenarios all passing validator.
