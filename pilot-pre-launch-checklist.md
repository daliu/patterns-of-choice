...
- [x] Scenario corpus, schema-validated (currently 42/48; sufficient for n=10 pilot)
...
- [ ] **Author final 6 scenarios** to reach 48 corpus total (currently 42). Symmetric 12/domain (or another sensible allocation). Output: 48 scenarios all passing validator.
