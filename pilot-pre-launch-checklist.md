...
- [x] Scenario corpus, schema-validated (currently 45/48; sufficient for n=10 pilot)
...
- [ ] **Author final 3 scenarios** to reach 48 corpus total (currently 45). Distribution so far: 6 QF + 3 Narr + 2 CoV per domain × 4 = 44, plus cov-truth-003. Output: 48 scenarios all passing validator.
