...
### 19.5 R1b — meta-moderation: the gap leg + the H12 dampening leg (BUILT, directional — cohort validity checks)
...
**DEFERRED — the H10 / H11 dampening legs.** Whether internalization *also* blunts the framing (H10) / anchor (H11) asymmetries is a natural R1b extension held for later: each adds two more cohort channels for descriptive-only companions, and each couples to its own §15/§16 pipeline exactly as the H10b / H11b discriminant halves do.
