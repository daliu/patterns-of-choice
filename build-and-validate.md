...
**What's implemented = the core validity spine (H2–H7), plus H9 self-calibration and H10 cross-situational consistency (both partial — see items 1–2 for the deferred discriminants + JS reveals). What's spec-only = the remaining measurement branches (H8, H11–H12, the A-series, R1–R6).** That gap is this backlog.
